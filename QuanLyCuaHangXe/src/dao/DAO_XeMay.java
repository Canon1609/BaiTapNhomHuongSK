...
public class DAO_XeMay {
    ...
    public boolean addXeMay(XeMay xe) {
        ...
        try {
            ...
            xeAdd.setString(3,xe.getSoKhung());
            xeAdd.setString(4,xe.getSoMay());
    ...
    public boolean updateXeMay(String maXe, XeMay xm) {
        ...
        try {
            ...
            stmt.setString(2,xm.getSoKhung());
            stmt.setString(3,xm.getSoMay());
    ...
    public List<XeMay> getLS() {
        ...
        try {
            ...
            while(rs.next()){
                XeMay xe =new XeMay(rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),
    ...
    public List<XeMay> TimKiem(String maXe){
        ...
        try{
            ...
            ResultSet rs = stmt.executeQuery();
            while(rs.next()) {
                XeMay xe1 = new XeMay(rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),
                        rs.getString(5),rs.getDouble(6));
                xe.add(xe1);
            }
        }catch (SQLException e){
    ...
    public XeMay TimKiemXe(String maXe){
        ...
        try{
            ...
            ResultSet rs = stmt.executeQuery();
            while(rs.next()) {
                xe1 = new XeMay(rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),
                        rs.getString(5),rs.getDouble(6));
            }
        }catch (SQLException e){
            e.printStackTrace();
