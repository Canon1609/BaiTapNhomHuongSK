...
public class PhieuXuat_Form extends JPanel {
    ...
    public void doShow(){
        ...
        btnThem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	if(valid())
            	{
                    pxDao = new DAO_PhieuXuat();
                    ctPXDao = new DAO_CT_PhieuXuat();
        ...
        btnHuy.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				txtNgayXuat.setText("");
				txtThue.setText("");
				cbcMaKH.setSelectedItem("KH01");
				cbcMaNV.setSelectedItem("NV01");
				cbcMX.setSelectedItem("X01");
    ...
    public boolean valid() {
    	if(txtMaPX.getText().equals("") || txtNgayXuat.getText().equals("") ||txtThue.getText().equals("")) 
    	{
    		JOptionPane.showMessageDialog(null, "Không được rỗng");
    		return false;
    	}
    	if(!(txtMaPX.getText().matches("PX\\d+"))) {
    		JOptionPane.showMessageDialog(null, "Mã phiếu xuất theo mẫu : PX01");
    		txtMaPX.requestFocus();
    		return false;
    	}
    	if(!(txtNgayXuat.getText().matches("^([0-9]{4})-([0-9]{2})-([0-9]{2})$"))) {
    		JOptionPane.showMessageDialog(null, "Ngày xuất  phải theo mẫu: YYYY-MM-DD");
